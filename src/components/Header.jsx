...
const Header = () => {
  ...
  // console.log("setMobileMenu: ", setMobileMenu);
  ...
  return (
    <div className="sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-black dark:bg-white">
      ...
      <div className="group flex items-center">
        ...
        <button className="w-[40px] md:w-[60px] h-0 md:h-10 flex items-center justify-center border-l-0 border-[#303030] rounded-r-3xl bg-white/[0.1]">
          {" "}
          <IoIosSearch className="text-white text-xl" />
        </button>
      </div>
